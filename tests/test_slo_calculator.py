...
class TestCalculateBudget:
    ...
    def test_no_consumption_full_budget_remaining(self) -> None:
        ...
        budget = calculate_budget(slo_target_pct=99.9, window_days=30, consumed_minutes=0.0)
    ...
    def test_partial_consumption(self) -> None:
        ...
        budget_half = calculate_budget(slo_target_pct=99.9, window_days=30, consumed_minutes=half)
    ...
    def test_exhausted_budget(self) -> None:
        ...
        budget_over = calculate_budget(slo_target_pct=99.9, window_days=30, consumed_minutes=over)
    ...
    def test_critical_threshold_below_10_pct(self) -> None:
        ...
        budget_critical = calculate_budget(slo_target_pct=99.9, window_days=30, consumed_minutes=consumed)
    ...
    def test_warning_threshold_below_25_pct(self) -> None:
        ...
        budget_warning = calculate_budget(slo_target_pct=99.9, window_days=30, consumed_minutes=consumed)
    ...
    def test_policy_tier_freeze_at_critical(self) -> None:
        ...
        budget = calculate_budget(slo_target_pct=99.9, window_days=30, consumed_minutes=consumed)
...
class TestCLI:
    ...
    def test_cli_json_output(self, capsys: pytest.CaptureFixture[str]) -> None:
        ...
        result = main(["--slo", "99.95", "--window", "30", "--consumed-minutes", "5.0", "--json"])
        assert result == 0
        captured = capsys.readouterr()
    ...
    def test_cli_exhausted_returns_nonzero(self, capsys: pytest.CaptureFixture[str]) -> None:
    ...
    def test_cli_invalid_slo_returns_error(self, capsys: pytest.CaptureFixture[str]) -> None:
